...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		double wordCount = getNumWords();
		double sentCount = getNumSentences();
		double syllCount = getNumSyllables();
		
		double r1 = -1.015*(wordCount/sentCount);
		double r2 = -84.6*(syllCount/wordCount);
		score += r1+r2;
